...
class LaravelLogViewer
{
    ...
    public function __construct($app = 'default')
    {
        ...
        $this->storage_path = function_exists('config') ? config("logview.app.{$app}.storage_path", storage_path('logs')) : storage_path('logs');
    ...
    public function all()
    {
        ...
        $max_file_size = function_exists('config') ? config('logview.max_file_size', self::MAX_FILE_SIZE) : self::MAX_FILE_SIZE;
    ...
    {
        $pattern = function_exists('config') ? config('logview.pattern', '*.log') : '*.log';
        $files = glob(
