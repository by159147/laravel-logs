...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      <h1><i class="fa fa-calendar" aria-hidden="true"></i> laravel 日志 管理</h1>
      <p class="text-muted"><i>faed</i></p>

      <div class="custom-control custom-switch" style="padding-bottom:20px;">
        <input type="checkbox" class="custom-control-input" id="darkSwitch">
        <label class="custom-control-label" for="darkSwitch" style="margin-top: 6px;">夜晚模式</label>
      </div>
          ...
          @foreach($logs as $key => $log)
            <tr data-display="stack{{{$key}}}">
              @if ($standardFormat)
                ...
                <td class="text highlight">{{$log['context']}}</td>
              @endif
...
{{--不能加载的js在里面找 https://www.bootcdn.cn/--}}

<!-- jQuery for Bootstrap -->
<script src="https://cdn.bootcdn.net/ajax/libs/jquery/3.2.1/jquery.slim.min.js"
...
<script>
  ...
  $(document).ready(function () {
    ...
    // });
      //点击展开按钮
      $('.table-container tr td button').on('click', function () {
          console.log($(this));
          $('#' + $(this).data('display')).toggle();
      });
